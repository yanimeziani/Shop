<nav class="navbar navbar-expand-md navbar-light bg-light">
    <a class="navbar-brand mx-4" href="index.php"><img src="img/logo.svg" alt="Logo" style="width: 200px;"></a>
    <button class="navbar-toggler me-5" type="button" data-bs-toggle="collapse" data-bs-target="#navigation" aria-controls="navigation" aria-expanded="false" aria-label="Toggle navigation">
